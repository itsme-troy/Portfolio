...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "dbb44b99-909b-4ab3-a01a-87d4e424c6d4");
  ...
  return (
    <motion.div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/
        ...
        <motion.h4 className='text-center mb-2 text-lg font-Ovo'
            initial={{y: -20, opacity: 0}} // start as nothing 
        ...
        <motion.p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'
            initial={{ opacity: 0}} // start as nothing 
        ...
        <motion.form onSubmit={onSubmit} className='max-w-2xl mx-auto'
            ...
            <motion.div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 mb-8'
                initial={{ x: -50, opacity: 0}} // start as nothing 
                whileInView={{x: 0, opacity: 1}} // end on orig size
